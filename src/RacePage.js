...
const priestRacials = { //priests have 2 extra racial skills.
...
function checkUseful(racialName, selectedClass){ //grey out useless racial skills.
    let useful = "";
...
function RacePage(props) {
    ...
    if (selectedClass === "priest"){
        final = baseSkills.concat(priestSkills) //add priest-exclusive racials to the array.
    }
        return(        
            <div class="row">
                <div class="col-sm-1 col-lg-3"></div>
                <div class="col-sm-9 col-lg-6">
                {final.map(racial => ( //repeat for the length of racials array.
